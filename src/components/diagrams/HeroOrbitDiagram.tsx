...
// === Shared hero diagram: static (no rotation) circle of colored icon
// nodes around a large centered ThunderOne logo mark, with dotted
// spokes/ring, small fixed dot accents, and a caption badge below. Used by
// both the home page hero and the solutions page hero — nodes/caption are
// passed in as props so each page controls its own labels/colors/order. ===
  ...
  return (
    <div className="mx-auto w-full max-w-md">
      <div className="relative aspect-square w-full">
        ...
        <div className="absolute left-1/2 top-1/2 flex h-44 w-44 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-slate-100 bg-white shadow-lg">
          <Image src={thunderOneMark} alt="ThunderOne" className="h-auto w-24" />
        </div>
      </div>

      <div className="-mt-6 rounded-2xl border border-slate-100 bg-white px-6 py-4 text-center shadow-md">
