...
// สื่อถึงความท้าทายที่องค์กรกำลังเผชิญเรื่องการมองเห็นและควบคุมสินทรัพย์ —
// ไอคอนทั้งหมดใช้โทนน้ำเงินเดียวกัน ===

import type { LucideIcon } from "lucide-react";
import { Clock3, Database, EyeOff, Gauge, Wrench } from "lucide-react";
import type { ChallengeContent } from "../types";

const ICONS: LucideIcon[] = [EyeOff, Wrench, Gauge, Database, Clock3];
